...
export default function RegistrationLog() {
  ...
  return (
    <MetaProvider>
      <Title>Registration Log - ECWA Theological Seminary, Jos (JETS)</Title>
      <Meta
        name="description"
        content="Registration Log on ECWA Theological Seminary, Jos (JETS)"
      />
      <div class="text-sm">
        <Header />
                            ...
                            <tr class="even:bg-gray-200 odd:bg-white border-b border-black">
                              ...
                              <td class="p-4 flex space-y-2 sm:space-x-2 sm:space-y-0">
                                ...
                                >
                                  ...
                                  <Show
                                    when={registration.undertaking === "yes"}
                                  >
                                    <span class="gray-btn p-3 inline-block">
                                      T
                                    </span>
                                  </Show>
                                </Show>
